<template>
  <section>
    <form @submit.prevent="submitAcademicForm" class="sm:w-[900px]">
      <div class="mx-auto">
        ...
        >
          ...
          >
            ...
            >
              ...
              <input
                v-if="input.title !== 'Action' && input.id % 9 !== 0"
                :id="input.id"
              ...
              />
              <!-- v-model="inputValueso[rowIndex][key]" -->
              <!-- {{ inputValueso[rowIndex]inputValueso[rowIndex] }} -->
              <!-- Passport Section  -->
              <FileUpload
                v-if="input.id % 9 === 0"
...
<script setup>
  ...
  const addInputRow = () => {
    ...
    const newRowValues = Array(9).fill("");
